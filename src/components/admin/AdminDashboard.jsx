...
const AdminDashboard = () => {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold text-[#1a2957] mb-6">Dashboard</h1>
      {error && <p className="text-red-500 mb-4">{error}</p>}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl text-[#1a2957] font-semibold">Total Blogs</h2>
          <p className="text-2xl text-[#1a2957]">{blogs.length}</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl text-[#1a2957] font-semibold">Published Blogs</h2>
          <p className="text-2xl text-[#1a2957]">
            {blogs.filter((blog) => blog.status === 'published').length}
          </p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl text-[#1a2957] font-semibold">Draft Blogs</h2>
          <p className="text-2xl text-[#1a2957]">
